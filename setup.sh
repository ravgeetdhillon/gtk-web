...
curl -o- https://gitlab.gnome.org/api/v4/projects/665/repository/tags?search=^3.24 > _data/api_fetch/stable_tags.json
curl -o- https://gitlab.gnome.org/api/v4/projects/665/repository/tags?search=^3.9 > _data/api_fetch/devel_tags.json
